...
public class MekanismRecipeProvider extends BaseRecipeProvider {
    ...
    private void addNuggetRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        addNuggetRecipe(consumer, MekanismItems.COPPER_NUGGET, MekanismTags.Items.INGOTS_COPPER, basePath, "copper");
        addNuggetRecipe(consumer, MekanismItems.OSMIUM_NUGGET, MekanismTags.Items.INGOTS_OSMIUM, basePath, "osmium");
        ...
        addNuggetRecipe(consumer, MekanismItems.TIN_NUGGET, MekanismTags.Items.INGOTS_TIN, basePath, "tin");
    }
    ...
    private void addOreProcessingIngotRecipes(Consumer<IFinishedRecipe> consumer, String basePath, net.minecraft.util.IItemProvider ore, Tag<Item> oreTag,
        ...
        addSmeltingBlastingRecipes(consumer, Ingredient.fromTag(dustTag), ingot, 0.5F, 200, Mekanism.rl(basePath + "ingot/from_dust_blasting"),
              Mekanism.rl(basePath + "ingot/from_dust_smelting"));
        if (notVanilla) {
            //from block
            ...
            addSmeltingBlastingRecipes(consumer, Ingredient.fromTag(oreTag), ingot, 1, 200, Mekanism.rl(basePath + "ingot/from_ore_blasting"),
                  Mekanism.rl(basePath + "ingot/from_ore_smelting"));
        }
        //Ore
        //from dust
        CombinerRecipeBuilder.combining(
    ...
    private void addStorageBlockRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        addStorageBlockRecipe(consumer, MekanismBlocks.COPPER_BLOCK, MekanismTags.Items.INGOTS_COPPER, basePath);
        addStorageBlockRecipe(consumer, MekanismBlocks.OSMIUM_BLOCK, MekanismTags.Items.INGOTS_OSMIUM, basePath);
        ...
        addStorageBlockRecipe(consumer, MekanismBlocks.TIN_BLOCK, MekanismTags.Items.INGOTS_TIN, basePath);
        //Charcoal
    ...
    private void addTierInstallerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        addTierInstallerRecipe(consumer, basePath, MekanismItems.ADVANCED_TIER_INSTALLER, MekanismTags.Items.INGOTS_OSMIUM, MekanismTags.Items.ALLOYS_INFUSED, MekanismTags.Items.CIRCUITS_ADVANCED);
